...
const workbox1 = document.querySelector(".workbox")
const workbox2 = document.querySelector(".workbox2")

let selector = document.querySelector(".selected")
let selectorOptions = document.querySelectorAll(".options>div")
let selectedCurr = document.querySelector(".selected-currency")
let options = document.querySelector(".options")
const selectorr = document.querySelector(".selector")

const amountOptionsDiv = document.querySelector(".amount-options")

let amountOptions = document.querySelectorAll(".amount-option")
let amountText = document.querySelectorAll(".amount-amount")
...
const selectorInners = [`<div class="selected">
<div class="selected-currency">ETH</div>
<img src="img/down-arrow.svg">
</div>
<div class="options">
<div class="selected-option">ETH</div>
<div>DAI</div>
<div>cDAI</div>
<div>USDC</div>
<div>USDT</div>
<div>WBTC</div>
    ...
    `<div class="selected">
<div class="selected-currency">BNB</div>
<img src="img/down-arrow.svg">
</div>
<div class="options">
<div class="selected-option">BNB</div>
</div>`,

    `<div class="selected">
<div class="selected-currency">MATIC</div>
<img src="img/down-arrow.svg">
</div>
<div class="options">
<div class="selected-option">MATIC</div>
</div>`,
...
<div class="selected-option">ETH</div>
    ...
    `<div class="selected">
<div class="selected-currency">xDAI</div>
<img src="img/down-arrow.svg">
</div>
<div class="options">
<div class="selected-option">xDAI</div>
</div>`,

    `<div class="selected">
<div class="selected-currency">AVAX</div>
<img src="img/down-arrow.svg">
</div>
<div class="options">
<div class="selected-option">AVAX</div>
</div>`,
...
const amountInners = [`<div class="amount-option selected-amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">0.1 ETH</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">1 ETH</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">10 ETH</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">100 ETH</div>
</div>
<div class="amount-line"></div>`,



`<div class="amount-option selected-amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">0.1 BNB</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">1 BNB</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">10 BNB</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">100 BNB</div>
</div>
<div class="amount-line"></div>`,
...
<div class="amount-amount">100 MATIC</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">1K MATIC</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">10K MATIC</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">100K MATIC</div>
</div>
<div class="amount-line"></div>`,
...
<div class="amount-amount">1 xDAI</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">1k xDAI</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">10k xDAI</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">100k xDAI</div>
</div>
<div class="amount-line"></div>`,
...
<div class="amount-amount">10 AVAX</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">100 AVAX</div>
</div>
<div class="amount-option">
<div class="amount-circle">
    <div class="amount-inner-circle"></div>
</div>
<div class="amount-amount">500 AVAX</div>
</div>
<div class="amount-line"></div>`,
...
<div class="amount-line"></div>`,
    ...
    <div class="amount-amount">100 DAI</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">1K DAI</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">10K DAI</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">100K DAI</div>
</div>
<div class="amount-line"></div>`,
    ...
    <div class="amount-amount">5K cDAI</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">50K cDAI</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">500K cDAI</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">5M cDAI</div>
</div>
<div class="amount-line"></div>`,
    ...
    <div class="amount-amount">100 USDC</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">1K USDC</div>
</div>
...
<div class="amount-line"></div>`,
    ...
    <div class="amount-amount">100 USDT</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">1K USDT</div>
</div>
...
<div class="amount-line"></div>`,
    ...
    <div class="amount-amount">0.1 WBTC</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">1 WBTC</div>
</div>
<div class="amount-option">
    <div class="amount-circle">
        <div class="amount-inner-circle"></div>
    </div>
    <div class="amount-amount">10 WBTC</div>
</div>
<div class="amount-line"></div>`
...
for (let i = 0; i < amountOptions.length; i++) {
    amountOptions[i].addEventListener("click", () => {
        for (let j = 0; j < amountOptions.length; j++) {
            amountOptions[j].classList.remove("selected-amount-option")
        }
        amountOptions[i].classList.add("selected-amount-option")
        amountBox.innerText = amountText[i].innerText
        selectorFuncs()
    })
}

function selectorFuncs() {

    selector = document.querySelector(".selected")
    selectorOptions = document.querySelectorAll(".options>div")
    selectedCurr = document.querySelector(".selected-currency")
    options = document.querySelector(".options")
    selector.addEventListener("click", () => {
        options.style.display = "flex"
        selector.style.border = "1px solid #94febf"
    })

    for (let i = 0; i < selectorOptions.length; i++) {
        selectorOptions[i].addEventListener("click", () => {
            selectedCurr.innerText = selectorOptions[i].innerText
            options.style.display = "none"
            selector.style.border = "1px solid #393939"
            for (let j = 0; j < selectorOptions.length; j++) {
                selectorOptions[j].classList.remove("selected-option")
            }
            selectorOptions[i].classList.add("selected-option")
            if(theI==0||theI==7){
                amountOptionsDiv.innerHTML=otherAmountInners[i]
                selectorFuncs()
            }
        })
    }
    ...
    amountText = document.querySelectorAll(".amount-amount")
...
for (let i = 0; i < modalOptions.length; i++) {
    modalOptions[i].addEventListener("click", () => {
        for (let j = 0; j < iconDivs.length; j++) {
            ...
            selectorr.innerHTML = selectorInners[i]
            amountOptionsDiv.innerHTML = amountInners[i]
            theI = i
            selectorFuncs()
        }
        modal.style.display = "none"
...
depositBtn.addEventListener("click", () => {
    depositBtn.classList.add("selected-dw")
    withdrawBtn.classList.remove("selected-dw")
    workbox1.style.display = "flex"
    workbox2.style.display = "none"
})

withdrawBtn.addEventListener("click", () => {
    withdrawBtn.classList.add("selected-dw")
    depositBtn.classList.remove("selected-dw")
    workbox2.style.display = "flex"
    workbox1.style.display = "none"
})